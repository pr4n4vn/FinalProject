...
```{r}
glm_predictions <- predict(best_glm, Test_data, type = "prob")
tree_predictions <- predict(class_tree, Test_data, type = "prob")
randomforest_predictions <- predict(random_forest, Test_data, type = "prob")
...
model <- names_models[model_index]
print(paste("The overall best model is:", model))
```
