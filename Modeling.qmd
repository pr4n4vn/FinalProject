...
glm_logLoss <- logLoss(glm_predictions, as.numeric(as.character(Test_data$Diabetes_binary)))
tree_logLoss <- logLoss(tree_predictions, as.numeric(as.character(Test_data$Diabetes_binary)))
rf_logLoss <- logLoss(randomforest_predictions, as.numeric(as.character(Test_data$Diabetes_binary)))
