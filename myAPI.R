...
# Convert relevant columns to factors and create binary diabetes variable
# data <- data %>%
#   mutate(Diabetes_binary = factor(ifelse(Diabetes_012 == 2, "Yes", "No")),  # Create binary diabetes variable as a factor
